...
SMODS.Joker {
	...
	calculate = function(self, card, context)
		if context.end_of_round and pseudorandom('enotsworra_fuck') < (G.GAME.probabilities.normal or 1)/card.ability.odds and not context.repetition and not context.individual and not context.retrigger_joker_check then
			local new_sign = nil
